...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="DIAM" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range render="true" symbol="0" lower="5.000000" upper="9.000000" label="5 - 9"/>
      <range render="true" symbol="1" lower="9.000000" upper="11.000000" label="9 - 11"/>
      <range render="true" symbol="2" lower="11.000000" upper="15.000000" label="11 - 15 "/>
      <range render="true" symbol="3" lower="15.000000" upper="20.000000" label="15 - 20"/>
    </ranges>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="253,188,130,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
